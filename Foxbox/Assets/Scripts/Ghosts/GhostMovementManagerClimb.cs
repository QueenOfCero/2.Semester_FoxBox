...
{
    public class GhostMovementManagerClimb : MonoBehaviour
    {
        /*
           =====================================================
      ...
      //  [Tooltip("If enabled raycasts will be visualised in the editor")]
       // [SerializeField] private bool showRayCastLines = true;
        ...
        public GameObject ClimbTutorialStart;

        private bool deactivateJumpTrigger;
        public GameObject ghostSquirrelJump;
        public GameObject ghostSquirrelClimb;
        public GameObject ghostSquirrelRight;
        public GameObject ghostSquirrelStop;

        public GhostClimbingMovement climbingMovement;

        public GameObject ghostSquirrelSpawn;
        ...
        private void ListenToTrigger()
        {
            if (deactivateJumpTrigger)
            {
                ...
                ClimbTutorialStart.SetActive(false);
                return;
            }
            if (ClimbTutorialStart.activeInHierarchy) {
                GhostSquirrelRight();
                GhostSquirrelJump();
        ...
        public void ReceiveTrigger(string target, string action)
        {
            Debug.Log("Reset Trigger Received");
            ...
            if (action == "Reset")
            {
                ...
                // gameObject.transform.parent = ghost squirrel respawn point;
                gameObject.transform.position = ghostSquirrelSpawn.transform.position;
                GhostSquirrelStop();
            ...
            if (action == "ClimbDown")
            {
                GhostSquirrelClimbDown();
            }


            if (action == "JumpOff")
            {
                GhostSquirrelJumpOff();
            }
        ...
        private void GhostSquirrelStop()
        {

            isLeftPressed = false;
            isRightPressed = false;
            shouldClimb = false; shouldClimb = false;
            shouldClimbDown = false;
            shouldJump = false;
            climbingMovement.ghostClimbInput = 0;

        }



        private void GhostSquirrelClimbDown()
        {
            shouldClimbDown = true;
            shouldClimb = false;
            climbingMovement.ghostClimbInput = -1;

        }


        private void GhostSquirrelLeft()
        {
            isLeftPressed = true;
            isRightPressed = false;
        }
        ...
        private void GhostSquirrelRight()
        {
            isRightPressed = true;
        ...
        private void GhostSquirrelClimb()
        {
            shouldClimb = true;
            shouldClimbDown = false;
        ...
        private void GhostSquirrelJump()
        {
           
            Jump();
        }

        private void GhostSquirrelJumpOff()
        {
        }
